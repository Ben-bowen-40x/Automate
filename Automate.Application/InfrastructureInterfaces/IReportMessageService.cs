...
public interface IReportMessageService
{
    ...
    public List<ICustomerSubscription> GetCustomerRecords(List<long> msgNums, FileInfo customerLocation);
    public List<ICustomerSubscription> GetCustomerRecords(FileInfo customerLocation);
}
