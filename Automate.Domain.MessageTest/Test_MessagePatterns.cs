...
InlineData("I have fixed the problem with my credit card. It should go through now if you re-submit it. Sorry about the inconvenience. | Eric Bello", ),
...
InlineData("InlineData(Hello | we need a free estimation is that posible ?, true) // wants service", ),
