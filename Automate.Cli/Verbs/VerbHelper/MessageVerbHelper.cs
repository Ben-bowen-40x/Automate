...
{
    public const string HelpText = "Choose which type of message file you wish to analyze. The following options are case-sensitive: Pan, Leaf, ManualWebForm, GAdsLeaf";
